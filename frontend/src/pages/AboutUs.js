...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      {/* Hero Section */}
      <div className="bg-indigo-700 py-20 px-6 text-center text-white">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 italic">The Student Connection</h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-6 bg-indigo-50 rounded-2xl text-center">
              ...
              <p className="font-bold text-indigo-900 text-sm uppercase">OUSL Based</p>
            </div>
            <div className="p-6 bg-indigo-50 rounded-2xl text-center">
              <Code className="w-10 h-10 text-indigo-600 mx-auto mb-3" />
              <p className="font-bold text-indigo-900 text-sm uppercase">BSE Scholars</p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-24">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Meet the Developers</h2>
          <div className="flex flex-col md:flex-row justify-center gap-10">
            {team.map((member, index) => (
              <div key={index} className="w-full md:w-80 bg-white border border-gray-100 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center">
                ...
                <p className="text-indigo-600 font-semibold mb-4 italic text-sm">{member.role}</p>
        ...
        {/* Features / Offering */}
        <div className="bg-gray-900 rounded-[3rem] p-10 md:p-16 text-white shadow-2xl">
          <h2 className="text-3xl font-bold mb-10 text-center">What We’re Building</h2>
...
function FeatureCard({ title, desc }) {
  return (
    <div className="bg-gray-800 p-6 rounded-2xl hover:bg-gray-750 transition-colors">
